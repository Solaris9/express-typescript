...
declare module 'express-typescript/Controller' {
    ...
    export function Middleware(target: any, propertyKey: string, descriptor: PropertyDescriptor): void;
    export function Use(...functions: ((request: Request, response: Response, next: Function) => void)[]): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
